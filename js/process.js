...
let process = {
	...
	page2:function(){
		...
		let content = <div>
				this is page 2<br/><a href='sound.jsx' onClick={process.sound}>next</a>
			</div>;
	...
	page3:function(){
		...
		let content = <div>
				this is page 3<br/><a href='cat.jsx' onClick={process.cat}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page4:function(){
		...
		let content = <div>
				this is page 4<br/><a href='camel.jsx' onClick={process.camel}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page5:function(){
		...
		let content = <div>
				this is page 5<br/><a href='chicken.jsx' onClick={process.chicken}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page6:function(){
		...
		let content = <div>
				this is page 6<br/><a href='cow.jsx' onClick={process.cow}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page7:function(){
		...
		let content = <div>
				this is page 7<br/><a href='elephant.jsx' onClick={process.elephant}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page8:function(){
		...
		let content = <div>
				this is page 8<br/><a href='frog.jsx' onClick={process.frog}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page9:function(){
		...
		let content = <div>
				this is page 9<br/><a href='hawk.jsx' onClick={process.hawk}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page10:function(){
		...
		let content = <div>
				this is page 10<br/><a href='horse.jsx' onClick={process.horse}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page12:function(){
		...
		let content = <div>
				this is page 12<br/><a href='monkey.jsx' onClick={process.monkey}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page13:function(){
		...
		let content = <div>
				this is page 13<br/><a href='pig.jsx' onClick={process.pig}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page14:function(){
		...
		let content = <div>
				this is page 14<br/><a href='raccoon.jsx' onClick={process.raccoon}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page15:function(){
		...
		let content = <div>
				this is page 15<br/><a href='rooster.jsx' onClick={process.rooster}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
	...
	page16:function(){
		...
		let content = <div>
				this is page 16<br/><a href='snake.jsx' onClick={process.snake}>next</a>
			</div>;
			ReactDOM.render(content,document.getElementById('root'));
